...
public class KotlinParserBaseListener implements KotlinParserListener {
     ...
     */
    @Override
    public void enterAsExpressionTail(KotlinParser.AsExpressionTailContext ctx) {
    }
     ...
     */
    @Override
    public void exitAsExpressionTail(KotlinParser.AsExpressionTailContext ctx) {
    }
     ...
     */
    @Override
    public void enterLabeledExpression(KotlinParser.LabeledExpressionContext ctx) {
    }
     ...
     */
    @Override
    public void exitLabeledExpression(KotlinParser.LabeledExpressionContext ctx) {
    }
     ...
     */
    @Override
    public void enterDotQualifiedExpression(KotlinParser.DotQualifiedExpressionContext ctx) {
    }
     ...
     */
    @Override
    public void exitDotQualifiedExpression(KotlinParser.DotQualifiedExpressionContext ctx) {
    }
     ...
     */
    @Override
    public void enterIndexingExpression(KotlinParser.IndexingExpressionContext ctx) {
    }
     ...
     */
    @Override
    public void exitIndexingExpression(KotlinParser.IndexingExpressionContext ctx) {
    }
